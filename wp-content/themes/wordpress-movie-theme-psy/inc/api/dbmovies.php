...
<div class="box">
<h1><a href="https://dbmovies.org" target="_blank"><img src="<?php echo DT_DIR_URI; ?>/assets/img/dbmovies.png"></a> <i>by Goldregister</i></h1>
</div>
...
<div class="content">
		...
		<div class="dbmovies_copy">&copy; <?php echo date('Y'); ?> <a href="http://imdbfilm.top" target="_blank">goldregister</a></div>
...
$omdbiurl = "https://www.omdbapi.com/?apikey=c0d64821&i=" . $imdb;
$apiomdapi = wp_remote_get($omdbiurl);
$json_omdb = wp_remote_retrieve_body($apiomdapi);
$data = json_decode($json_1, TRUE);
$data1 = json_decode($json_omdb, TRUE);
// ##########################################
$a4 = $data1['imdbRating'];
$a5 = $data1['imdbVotes'];
$a6 = $data1['Rated'];
...
{
$upimg = 'https://image.tmdb.org/t/p/w185' . $get_img;
}
$b14 = 'https://image.tmdb.org/t/p/w780'. $data['backdrop_path'];
...
wp_set_object_terms($post_id, $a4, 'imdbRating', false);
wp_set_object_terms($post_id, "HD", 'quality', false);
wp_set_post_tags( $post_id, $b12. ' Online,Free,sitename,Watch ' .$b12,true); 
wp_set_post_tags( $post_id,$actores.'' ,true); 
wp_set_post_tags( $post_id,'putlocker' ,true);
wp_set_post_tags( $post_id,'putlockers' ,true); 
wp_set_post_tags( $post_id,'9movies' ,true); 
wp_set_post_tags( $post_id,'putlockertv' ,true); 
wp_set_post_tags( $post_id,'yesmovie' ,true); 
wp_set_post_tags( $post_id,'movietv' ,true); 
wp_set_post_tags( $post_id,'123movies' ,true); 
wp_set_post_tags( $post_id,'primewire' ,true); 
wp_set_post_tags( $post_id,'solarmovie' ,true); 
wp_set_post_tags( $post_id,'movie25' ,true); 
wp_set_post_tags( $post_id,'losmovie' ,true); 
wp_set_post_tags( $post_id,'watch32' ,true); 
wp_set_post_tags( $post_id,'movie4k' ,true); 
wp_set_post_tags( $post_id,'shockshare' ,true); 
wp_set_post_tags( $post_id,'gomovies' ,true); 
wp_set_post_tags( $post_id,'gostream' ,true); 
...
$backdrop = 'https://image.tmdb.org/t/p/w780'. $data2['backdrop_path'];
// Forech!
$i = '0';
...
wp_set_post_tags( $post_id,  $originalname
. ' Online,watchseries,watch series go,go movies series,Watch ' .$originalname,true);
wp_set_post_tags( $post_id,"Watch  $originalname Full Series ",true);
wp_set_post_tags( $post_id, $originalname. ' Putlockers ' ,true); 
wp_set_post_tags( $post_id,$actores.'' ,true); 
...
add_post_meta($post_id, "tv_eps_num", ($episodes) , true);
